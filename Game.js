function myFunction()  {
  ...
  //  alert("The first monster you will be facing called Html Boss , hope your html knowledge will help u here. ")
  //  alert("Relax ! don't be nervous . We will warm up with general information question . ")
